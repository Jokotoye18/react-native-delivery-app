...
const Index = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaView
      style={[globalStyles.container, { paddingHorizontal: wp(20) }]}
    >
      ...
      <Comp2
        ...
        subTitle="Alexandra Smith Cesu 31 k-2 5.st, SIA Chili Riga LV–1012 Latvia"
      />
    ...
    <View style={selected && [styles.row, { alignItems: "flex-start" }]}>
      ...
      >
        <MaterialCommunityIcons
          style={styles.comp2IconStyle}
          name={iconName}
          color={selected ? colors.SelectedViolet : colors.TextSecondary}
          size={selected ? 20 : 20}
        />
        <Text
          style={[
            styles.comp2TextStyle,
            {
              color: selected ? colors.SelectedViolet : colors.TextSecondary,
      ...
      {selected && (
        <Ionicons name="ios-checkmark" color={colors.TextSecondary} size={40} />
      )}
    </View>
  );
};
